import"./modulepreload-polyfill-Btlm8H0F.js";import{_ as e,a as t,d as n,f as r,i,l as a,m as o,n as s,p as c,r as l,s as u,t as d,u as f,x as p}from"./firebase-VBRKn9At.js";import{n as m}from"./toast-kV3jSCF7.js";/* empty css               */import{c as h,f as g,l as ee,o as te,r as ne,s as _,u as re}from"./tournament-rules-D9Tq3W95.js";import{t as v}from"./confirm-modal-Dnnch5Ng.js";import{n as ie,t as ae}from"./ranking-standings-Dec7PvHv.js";var y=[],b=[],x={general:[],A:[],B:[]},S={general:[{id:1,group:`general`}],A:[{id:2,group:`A`}],B:[{id:3,group:`B`}]},oe=4;function se(){return oe++}function ce(e,t=1){S[e].length=0;for(let n=0;n<t;n++)S[e].push({id:n===0?le(e):se(),group:e})}function C(e){x[e].length=0}function le(e){return e===`general`?1:e===`A`?2:3}function ue(e){let t=new Set;return S[e].forEach(e=>{e.p1&&t.add(e.p1.id),e.p2&&t.add(e.p2.id)}),t}function de(e,t,n){return b.some(r=>(r.group??`general`)===n&&(r.p1===e&&r.p2===t||r.p1===t&&r.p2===e))}function fe(e,t,n){return t.some(t=>t.id!==e.id&&!de(e.id,t.id,n))}function pe(){return{winnerPoolIds:[],loserPoolIds:[]}}function me(e){return e.length?e.reduce((e,t)=>e+t.games,0)/e.length:0}function he(e,t){return[...b].filter(n=>(n.group??`general`)===t&&(n.p1===e||n.p2===e)).sort((e,t)=>t.createdAt-e.createdAt)[0]}function w(e,t){let n=me(t),r=Math.max(0,n-e.games),i=e.lastPlayed?Date.now()-e.lastPlayed:999999999;return r*1e5+(999999999-i)}function T(e,t,n,r){if(de(e.id,t.id,n))return 1/0;let i=me(r),a=e.games<i,o=t.games<i,s=Math.abs(e.games-t.games),c=Math.abs(e.wins-t.wins),l=Math.abs(e.losses-t.losses),u=c*1e3+l*300+s*120;(a||o)&&(u=s*600+l*200-(e.wins+t.wins)*40);let d=he(e.id,n),f=he(t.id,n);if(d&&f&&d.id===f.id){let n=d.winner===e.id,r=f.winner===t.id;a||o?n!==r&&(u-=n||r?250:0):n!==r&&(u+=350)}return u}function ge(e,t){let n=new Set(t.map(e=>e.id));return x[e].filter(([t,r])=>n.has(t.id)&&n.has(r.id)&&t.id!==r.id&&!de(t.id,r.id,e))}function _e(e,t){return e.filter(e=>!t.has(e.id))}function ve(e,t,n,r,i){let a=e.filter(e=>!t.has(e.id));if(a.length<2)return;let o=[...a].sort((e,t)=>w(t,n)-w(e,n)),s=o[0],c=null,l=1/0;for(let e=1;e<o.length;e++){let t=o[e],i=T(s,t,r,n);i<l&&(l=i,c=t)}!c||!Number.isFinite(l)||(i.push([s,c]),t.add(s.id),t.add(c.id))}function ye(e,t,n,r,i,a){let o=new Map(n.map(e=>[e.id,e])),s=e.filter(e=>o.has(e)&&!t.has(e));for(;s.length>=2;){let e=s.shift(),n=o.get(e);if(!n||t.has(n.id))continue;let c=-1,l=1/0;if(s.forEach((e,a)=>{let s=o.get(e);if(!s||t.has(s.id))return;let u=T(n,s,i,r);u<l&&(l=u,c=a)}),c===-1||!Number.isFinite(l))continue;let[u]=s.splice(c,1),d=o.get(u);d&&(a.push([n,d]),t.add(n.id),t.add(d.id))}return s}function be(e,t,n,r,i,a,o){let s=new Set(r.map(e=>e.id)),c=(t.winnerPoolIds??[]).filter(e=>s.has(e)&&!n.has(e)),l=(t.loserPoolIds??[]).filter(e=>s.has(e)&&!n.has(e)),u=new Map(r.map(e=>[e.id,e]));e.forEach(e=>{if(n.has(e.id))return;let t=[...c,...l],r=null,s=1/0;t.forEach(t=>{if(t===e.id||n.has(t))return;let o=u.get(t);if(!o)return;let l=T(e,o,a,i);c.includes(t)&&(l-=180),e.games===0&&c.includes(t)&&(l-=120),l<s&&(s=l,r=o)}),!(!r||!Number.isFinite(s))&&(o.push([e,r]),n.add(e.id),n.add(r.id))}),t.winnerPoolIds=c.filter(e=>!n.has(e)),t.loserPoolIds=l.filter(e=>!n.has(e))}function xe(e,t,n,r,i=pe()){let a={winnerPoolIds:[...i.winnerPoolIds??[]].filter(e=>e!==t.id&&e!==n.id),loserPoolIds:[...i.loserPoolIds??[]].filter(e=>e!==t.id&&e!==n.id)};return fe(t,r,e)&&a.winnerPoolIds.push(t.id),fe(n,r,e)&&a.loserPoolIds.push(n.id),a}function Se(e,t,n=pe()){let r=ue(e),i=t.filter(e=>!r.has(e.id)),a=i.filter(t=>fe(t,i,e)),o=me(t),s=[...a].sort((e,n)=>w(n,t)-w(e,t)),c=new Set,l=ge(e,i);l.forEach(([e,t])=>{c.add(e.id),c.add(t.id)});let u={winnerPoolIds:[...n.winnerPoolIds??[]],loserPoolIds:[...n.loserPoolIds??[]]},d=s.filter(e=>!c.has(e.id)&&(e.games<o||e.games===0));ve(d,c,t,e,l),be(d,u,c,i,t,e,l),u.winnerPoolIds=ye(u.winnerPoolIds??[],c,i,t,e,l),u.loserPoolIds=ye(u.loserPoolIds??[],c,i,t,e,l);let f=_e(s,c);for(let n=0;n<f.length;n++){let r=f[n];if(c.has(r.id))continue;let i=null,a=1/0;for(let o=n+1;o<f.length;o++){let n=f[o];if(c.has(n.id))continue;let s=T(r,n,e,t);s<a&&(a=s,i=n)}i&&(l.push([r,i]),c.add(r.id),c.add(i.id))}return x[e].length=0,l.forEach(t=>x[e].push(t)),u}var E=!1,D=``;function Ce(){return y}function O(e){let t=e.trim();if(t.length<=20)return t;let n=t.split(/\s+/).filter(Boolean);if(n.length<=2)return t;let r=n[0],i=n[n.length-1],a=n.slice(1,-1).find(e=>e.length>2);return a?`${r} ${a.charAt(0)}. ${i}`:`${r} ${i}`}function we(e,t,n=!1){let r=``;n||(t===0&&(r=`gold`),t===1&&(r=`silver`),t===2&&(r=`bronze`));let i=$(e.id);return`
  ...
  `}function Te(e,t,n){let r=mt(t.filter(e=>D?e.name.toLowerCase().includes(D):!0),n??`general`),i=r.slice(0,5),a=r.slice(5),o=n?`ranking-hidden-${n}`:`ranking-hidden-general`;return`
    <div class="group-section ranking-group-card">
      ...
      ${r.length?`
            <div class="ranking-list">
              ${i.map((e,t)=>we(e,t)).join(``)}
              ${a.length>0?`
                    <div id="${o}" class="ranking-hidden ${E?`open`:``}">
                      ${a.map((e,t)=>we(e,t+5,!0)).join(``)}
  ...
  `}function Ee(e){return`<strong title="${e.name}">${O(e.name)}</strong>`}function De(){let e=new Set;at().forEach(t=>{Z(t).forEach(t=>{t.p1&&e.add(t.p1.id),t.p2&&e.add(t.p2.id)})}),document.getElementById(`playersPlaying`).innerText=String(e.size),document.getElementById(`playersWaiting`).innerText=String(Ce().filter(t=>t.active&&!e.has(t.id)).length),document.getElementById(`playersTotal`).innerText=String(Ce().length)}window.toggleRankingView=()=>{E=!E,k()},window.setRankingSearch=()=>{D=document.getElementById(`rankingSearch`)?.value.trim().toLowerCase()??``,k()};function k(){let e=document.getElementById(`ranking`),t=document.getElementById(`tables`),n=document.getElementById(`queue`),r=document.getElementById(`tableCount`),i=document.getElementById(`tournamentModeLabel`),a=document.getElementById(`rankingModeAction`),o=at();i&&(i.innerText=rt()),a&&(a.style.display=it()?`flow`:`none`,a.innerText=o.length===1?`Separar A e B`:`Juntar Categorias`),r&&(r.innerText=o.map(e=>`${Q(e)}: ${Z(e).length}`).join(` | `)),e.innerHTML=`
    <div class="group-compare-grid ${it()&&o.length>1?`dual`:`single`}">
      ${it()&&o.length>1?o.map(e=>`
                  <div class="group-column">
                    ${Te(Q(e),ot(e),e)}
                  </div>
                `).join(``):`<div class="group-column">${Te(`Ranking geral`,Ce())}</div>`}
    </div>
  `,t.innerHTML=`
  ...
  `,De()}var Oe=new URLSearchParams(window.location.search).get(`id`),ke=!1,A=null,j=[],Ae=new Set,M=[],N=null,P=null,F=null,I={general:{winnerPoolIds:[],loserPoolIds:[]},A:{winnerPoolIds:[],loserPoolIds:[]},B:{winnerPoolIds:[],loserPoolIds:[]}};function L(e){return(e??``).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#39;`)}function je(e){return e.split(` `).filter(Boolean).slice(0,2).map(e=>e[0]?.toUpperCase()??``).join(``)}function Me(){return{wins:0,losses:0,games:0,active:!0,createdAt:Date.now()}}function Ne(e){let t=e.playerProfile??Me(),n=z(e.id);return{id:e.id,name:e.name,wins:t.wins??0,losses:t.losses??0,games:t.games??0,active:t.active??!0,registrationCategory:n?.category,createdAt:t.createdAt??e.createdAt,lastPlayed:t.lastPlayed}}function R(e){return(e??``).normalize(`NFD`).replace(/[\u0300-\u036f]/g,``).trim().toLowerCase()}function Pe(e,t=13){let n=e.trim();if(n.length<=t)return n;let r=n.split(/\s+/).filter(Boolean);if(r.length>=2){let e=r[0],n=r[r.length-1],i=r.slice(1,-1).filter(e=>![`de`,`da`,`do`,`dos`,`das`,`e`].includes(e.toLowerCase()));if(i.length){let r=`${e} ${i[0][0]}. ${n}`;if(r.length<=t+6)return r;let a=`${e} ${i.map(e=>`${e[0]}.`).join(` `)} ${n}`.replace(/\s+/g,` `).trim();if(a.length<=t+8)return a}let a=`${e} ${n}`;if(a.length<=t+4)return a}return`${n.slice(0,Math.max(1,t-3)).trimEnd()}...`}function Fe(e){return e?new Intl.DateTimeFormat(`pt-BR`,{dateStyle:`medium`,timeStyle:`short`}).format(e):`Nao informado`}function z(e){return M.find(t=>t.id===e||t.uid===e)}function Ie(e){return j.find(t=>t.id===e)??null}function B(e=``){let t=R(e);return j.filter(e=>!e.profileComplete||e.role!==`user`&&e.role!==`admin`?!1:t?[e.name,e.email,e.club,e.category].some(e=>R(e).includes(t)):!0).map(e=>({user:e,registration:z(e.id),player:y.find(t=>t.id===e.id)})).sort((e,t)=>e.user.name.localeCompare(t.user.name))}function Le(e){return e.player?.active?{label:`Ativo`,helper:`Participando`,tone:`neutral`}:e.registration?.paymentStatus===`approved`?{label:`Pronto`,helper:`Inativo`,tone:`win`}:e.registration?.paymentStatus===`pending_payment`?{label:`Pendente`,helper:`Pagamento não aprovado`,tone:`loss`}:{label:`Novo`,helper:`Sem inscrição`,tone:`neutral`}}function Re(e=``){let t=document.getElementById(`athleteSearchResults`),n=document.getElementById(`athleteSearchMessage`);if(!t||!n)return;let r=e.trim(),i=B(r);r?i.length?n.textContent=`${i.length} atleta(s) encontrado(s).`:n.textContent=`Nenhum atleta encontrado para essa busca.`:n.textContent=`Digite para buscar atletas cadastrados.`,t.innerHTML=i.length?i.map(e=>{let t=Le(e),n=Pe(e.user.name.trim(),16),r=[e.user.club||`Sem clube`,e.user.category||`Sem categoria`].join(` - `);return`
          ...
          `}).join(``):``}function V(){Re(document.getElementById(`name`)?.value??``)}function ze(e){if(A){let t=ne(A,e.category);if(t.length)return t[0]}return e.category||A?.category||`Livre`}function Be(e,t){let n=A;if(!n)throw Error(`Torneio nao carregado.`);let r=Date.now(),i=ze(e),a=ee(n,[i]);return{registrationPayload:{id:e.id,uid:e.id,name:e.name,email:e.email,club:e.club,category:i,registrationFee:a,paymentStatus:t,paymentMethod:`pix`,registeredAt:r,status:`registered`},userRegistrationPayload:{id:n.id,tournamentId:n.id,title:n.title,location:n.location??``,category:i,categories:[i],registrationFee:a,paymentStatus:t,paymentMethod:`pix`,startDate:n.startDate,endDate:n.endDate,registrationDeadline:n.registrationDeadline,registeredAt:r,status:`registered`}}}function Ve(e){let t=document.getElementById(`athleteActivationModal`),n=document.getElementById(`athleteActivationTitle`),r=document.getElementById(`athleteActivationDescription`);!t||!n||!r||(F=e,n.textContent=`Ativar ${e.user.name}?`,r.textContent=`Confirme o status do pagamento para concluir a inscrição ou enviar o atleta para análise.`,t.style.display=`flex`)}function He(){let e=document.getElementById(`athleteActivationModal`);e&&(F=null,e.style.display=`none`)}async function Ue(e,t){let r=A;if(!r)return;let{registrationPayload:i,userRegistrationPayload:a}=Be(e.user,t),o=n(s);o.set(c(s,`tournaments`,r.id,`registrations`,e.user.id),i),o.set(c(s,`users`,e.user.id,`registrations`,r.id),a),t===`approved`&&o.set(c(s,`users`,e.user.id),{playerProfile:{...Me(),active:!0},updatedAt:Date.now()},{merge:!0}),await o.commit()}function H(){return te(A)}function U(){A&&(A.groupStates={general:{started:!1,tableCount:1,...A.groupStates?.general},A:{started:!1,tableCount:1,...A.groupStates?.A},B:{started:!1,tableCount:1,...A.groupStates?.B}})}function We(e){return U(),A?.groupStates?.[e]??{started:!1,tableCount:1}}function W(e){return!!We(e).started}function G(e){return We(e).tableCount??1}function Ge(e){(e?[e]:[`general`,`A`,`B`]).forEach(e=>ce(e,G(e)))}function K(e){(e?[e]:[`general`,`A`,`B`]).forEach(e=>C(e))}function Ke(e,t){A&&(e.delete(c(s,`tournaments`,A.id,`registrations`,t)),e.delete(c(s,`users`,t,`registrations`,A.id)),M=M.filter(e=>e.id!==t&&e.uid!==t),Ae.delete(t))}async function qe(e,t){A&&(U(),A.groupStates={...A.groupStates,[e]:{...A.groupStates?.[e],...t}},await a(c(s,`tournaments`,A.id),{groupStates:A.groupStates,updatedAt:Date.now()}))}function Je(){U(),[`general`,`A`,`B`].forEach(e=>{ce(e,G(e))})}function Ye(e){return A?.rankingLiveState?.[e]??{}}function Xe(){[`general`,`A`,`B`].forEach(e=>{C(e),ce(e,G(e));let t=Ye(e);I[e]={winnerPoolIds:[...t.scheduler?.winnerPoolIds??[]],loserPoolIds:[...t.scheduler?.loserPoolIds??[]]},(t.queue??[]).forEach(t=>{let[n,r]=t.playerIds,i=y.find(e=>e.id===n),a=y.find(e=>e.id===r);i&&a&&x[e].push([i,a])}),(t.activeTables??[]).forEach((t,n)=>{let r=t.playerIds,i=r?y.find(e=>e.id===r[0]):void 0,a=r?y.find(e=>e.id===r[1]):void 0;S[e][n]={id:t.id,group:e,...i?{p1:i}:{},...a?{p2:a}:{}}})})}async function q(){let e=A;e&&(e.rankingLiveState={general:{queue:x.general.map(([e,t])=>({playerIds:[e.id,t.id]})),activeTables:S.general.map(e=>({id:e.id,...e.p1&&e.p2?{playerIds:[e.p1.id,e.p2.id]}:{}})),scheduler:I.general},A:{queue:x.A.map(([e,t])=>({playerIds:[e.id,t.id]})),activeTables:S.A.map(e=>({id:e.id,...e.p1&&e.p2?{playerIds:[e.p1.id,e.p2.id]}:{}})),scheduler:I.A},B:{queue:x.B.map(([e,t])=>({playerIds:[e.id,t.id]})),activeTables:S.B.map(e=>({id:e.id,...e.p1&&e.p2?{playerIds:[e.p1.id,e.p2.id]}:{}})),scheduler:I.B}},A=e,await a(c(s,`tournaments`,e.id),{rankingLiveState:e.rankingLiveState,updatedAt:Date.now()}))}function Ze(e){let t=document.getElementById(`userSummary`);t&&(t.innerHTML=`
    <strong>${e.name}</strong>
    <span>${e.club||`Sem clube`}</span>
    <span>${e.category}</span>
  `)}function J(){document.getElementById(`activeTournamentName`).textContent=A?.title||`Torneio nao encontrado`,document.getElementById(`tournamentStatusLabel`).textContent=A?.status===`finished`?`Finalizado`:A?.isActive?`Em andamento`:A?.status===`open`?`Inscricoes abertas`:`Aguardando inicio`}function Qe(e=A?.finalStandings??[]){let t=document.getElementById(`finalResultsList`);if(t){if(!e.length){t.innerHTML=`<div class="empty-state">O resultado final ainda nao foi gerado.</div>`;return}t.innerHTML=H().filter(t=>e.some(e=>e.group===t)).map(t=>{let n=e.filter(e=>e.group===t);return`
  ...
  `,t.style.display=`flex`}async function nt(){if(!Oe){window.location.replace(`/pages/dashboard.html`);return}let e=await i(c(s,`tournaments`,Oe));if(!e.exists()){window.location.replace(`/pages/dashboard.html`);return}A={id:e.id,...e.data()},U(),J()}async function Y(){if(!A){j=[],M=[],y.length=0;return}let[e,n]=await Promise.all([t(r(s,`users`)),t(r(s,`tournaments`,A.id,`registrations`))]);M=n.docs.map(e=>({id:e.id,...e.data()})),Ae=new Set(M.filter(e=>e.paymentStatus===`approved`).map(e=>e.id)),j=e.docs.map(e=>({id:e.id,...e.data()})).filter(e=>e.role===`user`||e.role===`admin`).sort((e,t)=>e.name.localeCompare(t.name)),y.length=0,y.push(...j.filter(e=>e.profileComplete&&Ae.has(e.id)).map(e=>Ne(e)).sort((e,t)=>e.name.localeCompare(t.name))),V()}function rt(){return re(A)===`ranking`?`Ranking`:`Campeonato`}function it(){return g(A)}function at(){return H()}function X(e){let t=A;return t?y.filter(n=>n.active&&h(t,n.registrationCategory)===e):[]}function ot(e){let t=A;return t?y.filter(n=>h(t,n.registrationCategory)===e&&z(n.id)?.paymentStatus===`approved`):[]}function Z(e){return S[e]}function st(e){return x[e]}function Q(e){return _(e)}function ct(e){return!!(A&&A.status!==`finished`)&&X(e).length>=2}function lt(e){return W(e)}async function ut(){if(b.length=0,!A)return;let e=await t(r(s,`matches`));b.push(...e.docs.map(e=>({id:e.id,...e.data()})).filter(e=>e.tournamentId===A?.id).sort((e,t)=>e.createdAt-t.createdAt))}async function dt(){await nt(),await Promise.all([Y(),ut()]),Xe(),J(),k()}async function ft(){if(A)try{await Y(),k()}catch(e){console.error(`Erro ao atualizar inscricoes do torneio:`,e)}}function pt(){return y.filter(e=>z(e.id)?.paymentStatus===`approved`)}function mt(e,t=`general`){return ie(e,ht(t))}function ht(e){return b.filter(t=>t.tournamentId===A?.id&&(t.group??`general`)===e)}function gt(e){let t=X(e),n=[];for(let r=0;r<t.length;r++)for(let i=r+1;i<t.length;i++){let a=t[r],o=t[i];ht(e).some(e=>e.p1===a.id&&e.p2===o.id||e.p1===o.id&&e.p2===a.id)||n.push([a,o])}return n}function _t(){let e=A;return e?H().flatMap(t=>(()=>{let n=pt().filter(n=>h(e,n.registrationCategory)===t),{stats:r}=ae(n.map(e=>e.id),ht(t));return mt(n,t).map((e,n)=>{let i=n+1,a=r.get(e.id)??{wins:0,losses:0,games:0};return{playerId:e.id,name:e.name,category:e.registrationCategory||_(t),group:t,placement:`${i}o lugar`,result:vt(i),wins:a.wins,losses:a.losses,games:a.games}})})()):[]}function vt(e){return e===1?`Campeao`:e===2?`Vice-campeao`:e===3?`3o lugar`:`${e}o lugar`}function yt(){y.forEach(e=>{e.wins=0,e.losses=0,e.games=0,e.active=!1,e.lastPlayed=void 0}),b.length=0,K(),Ge(),I={general:{winnerPoolIds:[],loserPoolIds:[]},A:{winnerPoolIds:[],loserPoolIds:[]},B:{winnerPoolIds:[],loserPoolIds:[]}}}async function bt(){let e=A;if(!e||e.isActive)return;let i=await t(u(r(s,`tournaments`),f(`isActive`,`==`,!0))),a=n(s);i.forEach(t=>{t.id!==e.id&&a.update(t.ref,{isActive:!1,updatedAt:Date.now()})}),a.update(c(s,`tournaments`,e.id),{isActive:!0,status:`open`,updatedAt:Date.now()}),await a.commit(),A={...e,isActive:!0,status:`open`,updatedAt:Date.now()},J()}async function xt(e,t,r){let i=A;if(!i)return;let a=y.find(e=>e.id===t),l=y.find(e=>e.id===r);if(!a||!l)return;let u={id:e.id,tournamentId:i.id,tournamentTitle:i.title,opponentName:l.name,scoreLabel:`${e.score1} x ${e.score2}`,tableLabel:e.tableLabel,result:`win`,playedAt:e.createdAt},d={id:e.id,tournamentId:i.id,tournamentTitle:i.title,opponentName:a.name,scoreLabel:`${e.score2} x ${e.score1}`,tableLabel:e.tableLabel,result:`loss`,playedAt:e.createdAt},f={tournamentId:i.id,title:i.title,category:a.registrationCategory||i.category||`Livre`,result:`Em andamento`,matchCount:o(1),wins:o(1),losses:o(0),playedAt:e.createdAt},p={tournamentId:i.id,title:i.title,category:l.registrationCategory||i.category||`Livre`,result:`Em andamento`,matchCount:o(1),wins:o(0),losses:o(1),playedAt:e.createdAt},m=n(s);m.set(c(s,`users`,a.id,`matches`,e.id),u),m.set(c(s,`users`,l.id,`matches`,e.id),d),m.set(c(s,`users`,a.id,`tournaments`,i.id),f,{merge:!0}),m.set(c(s,`users`,l.id,`tournaments`,i.id),p,{merge:!0}),await m.commit()}function St(e){let t=S[e],n=x[e];for(let r=0;r<t.length;r++)if(!t[r].p1&&n.length){let i=n.shift();t[r]={id:t[r].id,group:e,p1:i[0],p2:i[1]}}}function Ct(e){return S[e].some(e=>e.p1&&e.p2)}function wt(e){return e?e.profileComplete?e.role===`admin`?e:(window.location.replace(`/pages/profile.html`),null):(window.location.replace(`/pages/complete-profile.html`),null):(window.location.replace(`/pages/login.html`),null)}async function Tt(e){return wt((await i(c(s,`users`,e))).data())}window.logout=async()=>{await p(d),window.location.replace(`/pages/login.html`)},window.goToDashboard=()=>{window.location.href=`/pages/dashboard.html`},window.editCurrentTournament=()=>{A&&(window.location.href=`/pages/tournament-form.html?id=${A.id}`)},window.openProfile=()=>{window.location.href=`/pages/profile.html`},window.openAthleteProfile=e=>{tt(e)},window.closeAthleteProfileModal=()=>{let e=document.getElementById(`athleteProfileModal`);e&&(e.style.display=`none`)},window.openFinalResultsModal=()=>{$e()},window.closeFinalResultsModal=()=>{et()},window.openTournamentRegistrations=()=>{A&&(window.location.href=`/pages/tournament-registrations.html?id=${A.id}`)},window.closeAthleteActivationModal=()=>{He()},e(d,async e=>{if(ke)return;if(ke=!0,!e){window.location.replace(`/pages/login.html`);return}let t=await Tt(e.uid);t&&(Ze(t),Je(),await dt(),window.addEventListener(`focus`,ft),document.addEventListener(`visibilitychange`,()=>{document.visibilityState===`visible`&&ft()}),N=window.setInterval(()=>{ft()},15e3))}),window.addEventListener(`beforeunload`,()=>{N!==null&&(window.clearInterval(N),N=null)}),window.addPlayer=async()=>{let e=document.getElementById(`name`),t=e.value.trim();if(t){await Y();try{let n=(P?B().find(e=>e.user.id===P):void 0)??B(t).find(e=>R(e.user.name)===R(t));if(!n){m(`Selecione um atleta da busca para ativar.`,`warning`);return}if(n.player?.active){m(`Esse jogador ja esta inscrito e ativo neste torneio.`,`warning`);return}if(n.registration?.paymentStatus===`approved`){let t=y.find(e=>e.id===n.user.id&&!e.active);if(!t){m(`Nao foi possivel ativar esse atleta agora.`,`error`);return}let r=A;if(!r){m(`Torneio nao encontrado.`,`error`);return}await a(c(s,`users`,t.id),{"playerProfile.active":!0,updatedAt:Date.now()}),t.active=!0,P=null,W(h(r,t.registrationCategory))&&(await q(),m(`Atleta reativado. Clique em 'Atualizar jogos' para incluir esse atleta na categoria.`,`info`)),y.sort((e,t)=>e.name.localeCompare(t.name)),e.value=``,V(),k(),m(`Atleta reativado com sucesso.`,`success`);return}Ve(n)}catch(e){m(`Erro ao ativar atleta: `+e.message,`error`)}}},window.searchAthletes=()=>{P=null,V()},window.selectAthleteCandidate=e=>{let t=document.getElementById(`name`),n=B().find(t=>t.user.id===e);!t||!n||(P=e,t.value=n.user.name,Re(n.user.name))},window.confirmAthletePaymentStatus=async e=>{let t=F,n=document.getElementById(`name`);if(t){if(e===`cancel`){He();return}try{if(await Ue(t,e),await Y(),e===`approved`){let e=A;if(!e){m(`Torneio nao encontrado.`,`error`);return}W(h(e,t.user.category))&&(await q(),m(`Atleta adicionado. Clique em 'Atualizar jogos' para incluir esse atleta na categoria.`,`info`))}e===`approved`?m(`Atleta adicionado automaticamente ao campeonato.`,`success`):m(`Inscrição adicionada para análise no gerenciamento de inscrições.`,`info`),P=null,n&&(n.value=``),He(),V(),k()}catch(e){m(`Erro ao registrar atleta: `+e.message,`error`)}}},window.approveRegistration=async e=>{if(A&&M.find(t=>t.id===e))try{let t=n(s);t.update(c(s,`tournaments`,A.id,`registrations`,e),{paymentStatus:`approved`}),t.update(c(s,`users`,e,`registrations`,A.id),{paymentStatus:`approved`}),await t.commit(),await Y(),k()}catch(e){m(`Erro ao aprovar pagamento: `+e.message,`error`)}},window.removeRegistration=async e=>{if(!A)return;let t=M.find(t=>t.id===e);if(t&&await v({title:`Remover inscrição`,message:`Remover a inscrição de ${t.name}?`,confirmLabel:`Remover`,tone:`danger`}))try{let t=n(s);Ke(t,e),t.update(c(s,`users`,e),{"playerProfile.active":!1,"playerProfile.games":0,"playerProfile.wins":0,"playerProfile.losses":0,"playerProfile.lastPlayed":null}),await t.commit(),await Y(),k()}catch(e){m(`Erro ao remover inscrição: `+e.message,`error`)}},window.toggleRankingMode=async()=>{if(!A||!g(A))return;if(b.length>0){m(`Nao e possivel juntar ou separar categorias apos iniciar partidas.`,`warning`);return}let e=A.rankingMode===`split`?`single`:`split`;await a(c(s,`tournaments`,A.id),{rankingMode:e,groupStates:{general:{started:!1,tableCount:1},A:{started:!1,tableCount:1},B:{started:!1,tableCount:1}},rankingLiveState:{general:{queue:[],activeTables:[{id:1}]},A:{queue:[],activeTables:[{id:2}]},B:{queue:[],activeTables:[{id:3}]}},updatedAt:Date.now()}),A={...A,rankingMode:e,groupStates:{general:{started:!1,tableCount:1},A:{started:!1,tableCount:1},B:{started:!1,tableCount:1}},rankingLiveState:{general:{queue:[],activeTables:[{id:1}]},A:{queue:[],activeTables:[{id:2}]},B:{queue:[],activeTables:[{id:3}]}}},K(),Ge(),await q(),k()},window.startGroup=async e=>{if(!A){m(`Torneio nao encontrado.`,`error`);return}if(!ct(e)){m(`Essa categoria precisa de pelo menos 2 atletas ativos.`,`warning`);return}await bt(),W(e)||await qe(e,{started:!0}),Ct(e)||C(e),I[e]=Se(e,X(e),I[e]),St(e),await q(),k()},window.resetMatches=async()=>{let e=A;if(e)try{let t=n(s);b.forEach(e=>{t.delete(c(s,`matches`,e.id)),t.delete(c(s,`users`,e.p1,`matches`,e.id)),t.delete(c(s,`users`,e.p2,`matches`,e.id))}),pt().forEach(n=>{t.update(c(s,`users`,n.id),{"playerProfile.wins":0,"playerProfile.losses":0,"playerProfile.games":0,"playerProfile.lastPlayed":null}),t.delete(c(s,`users`,n.id,`tournaments`,e.id))});let r={general:{started:!1,tableCount:G(`general`)},A:{started:!1,tableCount:G(`A`)},B:{started:!1,tableCount:G(`B`)}};t.update(c(s,`tournaments`,e.id),{groupStates:r,rankingLiveState:{general:{queue:[],activeTables:S.general.map(e=>({id:e.id})),scheduler:{winnerPoolIds:[],loserPoolIds:[]}},A:{queue:[],activeTables:S.A.map(e=>({id:e.id})),scheduler:{winnerPoolIds:[],loserPoolIds:[]}},B:{queue:[],activeTables:S.B.map(e=>({id:e.id})),scheduler:{winnerPoolIds:[],loserPoolIds:[]}}},updatedAt:Date.now()}),await t.commit(),b.length=0,A={...e,groupStates:r,rankingLiveState:{general:{queue:[],activeTables:S.general.map(e=>({id:e.id})),scheduler:{winnerPoolIds:[],loserPoolIds:[]}},A:{queue:[],activeTables:S.A.map(e=>({id:e.id})),scheduler:{winnerPoolIds:[],loserPoolIds:[]}},B:{queue:[],activeTables:S.B.map(e=>({id:e.id})),scheduler:{winnerPoolIds:[],loserPoolIds:[]}}}},K(),Ge(),I={general:{winnerPoolIds:[],loserPoolIds:[]},A:{winnerPoolIds:[],loserPoolIds:[]},B:{winnerPoolIds:[],loserPoolIds:[]}},await q(),k()}catch(e){m(`Erro ao resetar campeonato: `+e.message,`error`)}},window.resetAthleteMatches=async e=>{if(!A)return;let t=Ie(e),r=y.find(t=>t.id===e);if(!t||!r){m(`Atleta nao encontrado no torneio atual.`,`warning`);return}let i=b.filter(t=>t.tournamentId===A?.id&&(t.p1===e||t.p2===e));if(!i.length){m(`Esse atleta ainda nao possui partidas registradas neste ranking.`,`info`);return}if(await v({title:`Resetar partidas do atleta`,message:`Limpar ${i.length} partida(s) de ${t.name} neste ranking?`,confirmLabel:`Resetar partidas`,tone:`danger`}))try{let t=A;if(!t){m(`Torneio nao encontrado.`,`error`);return}let a=new Set([e]);i.forEach(e=>{a.add(e.p1),a.add(e.p2)});let o=b.filter(e=>!i.some(t=>t.id===e.id)),l=n(s);i.forEach(e=>{l.delete(c(s,`matches`,e.id)),l.delete(c(s,`users`,e.p1,`matches`,e.id)),l.delete(c(s,`users`,e.p2,`matches`,e.id))}),a.forEach(e=>{let n=o.filter(t=>t.tournamentId===A?.id&&(t.p1===e||t.p2===e)),r=n.filter(t=>t.winner===e).length,i=n.length-r,a=n.length?Math.max(...n.map(e=>e.createdAt)):null;l.update(c(s,`users`,e),{"playerProfile.wins":r,"playerProfile.losses":i,"playerProfile.games":n.length,"playerProfile.lastPlayed":a}),n.length?l.set(c(s,`users`,e,`tournaments`,t.id),{tournamentId:t.id,title:t.title,category:z(e)?.category||t.category||`Livre`,result:`Em andamento`,matchCount:n.length,wins:r,losses:i,playedAt:a??Date.now()},{merge:!0}):l.delete(c(s,`users`,e,`tournaments`,t.id))}),await l.commit(),b.length=0,b.push(...o),a.forEach(e=>{let t=y.find(t=>t.id===e),n=o.filter(t=>t.tournamentId===A?.id&&(t.p1===e||t.p2===e));t&&(t.wins=n.filter(t=>t.winner===e).length,t.losses=n.length-t.wins,t.games=n.length,t.lastPlayed=n.length?Math.max(...n.map(e=>e.createdAt)):void 0)});let u=h(t,r.registrationCategory);C(u),S[u]=S[u].map(t=>t.p1?.id===e||t.p2?.id===e?{id:t.id,group:u}:t),W(u)&&!Ct(u)&&(I[u]={winnerPoolIds:[],loserPoolIds:[]},I[u]=Se(u,X(u),I[u]),St(u)),await q(),k(),tt(e),m(`Partidas do atleta resetadas com sucesso.`,`success`)}catch(e){m(`Erro ao resetar partidas do atleta: `+e.message,`error`)}},window.finishTournament=async()=>{let e=A;if(!e)return;let t=_t();if(!t.length){m(`Adicione atletas e finalize partidas antes de encerrar o torneio.`,`warning`);return}if(H().flatMap(e=>gt(e)).length){m(`Ainda existem confrontos obrigatorios pendentes neste ranking.`,`warning`);return}if(await v({title:`Encerrar torneio`,message:`Encerrar o torneio "${e.title}"?\n\nEssa ação finaliza o ranking e grava a classificação dos atletas.`,confirmLabel:`Encerrar`,tone:`danger`}))try{let r=n(s),i=Date.now();t.forEach(t=>{let n={id:e.id,tournamentId:e.id,title:e.title,category:t.category||e.category||`Livre`,placement:t.placement,result:t.result,matchCount:t.games,wins:t.wins,losses:t.losses,playedAt:i};r.set(c(s,`users`,t.playerId,`tournaments`,e.id),n,{merge:!0}),r.update(c(s,`users`,t.playerId),{"playerProfile.wins":0,"playerProfile.losses":0,"playerProfile.games":0,"playerProfile.active":!1,"playerProfile.lastPlayed":null})}),r.update(c(s,`tournaments`,e.id),{isActive:!1,status:`finished`,finalStandings:t,updatedAt:i,completedAt:i}),await r.commit(),A={...e,isActive:!1,status:`finished`,finalStandings:t,updatedAt:i},J(),yt(),await q(),k(),$e(),m(`Torneio encerrado com sucesso.`,`success`)}catch(e){m(`Erro ao encerrar torneio: `+e.message,`error`)}},window.deletePlayer=async e=>{if(await v({title:`Remover atleta`,message:`Remover este atleta do torneio atual?`,confirmLabel:`Remover`,tone:`danger`}))try{let t=n(s);t.update(c(s,`users`,e),{"playerProfile.active":!1,"playerProfile.games":0,"playerProfile.wins":0,"playerProfile.losses":0,"playerProfile.lastPlayed":null}),Ke(t,e),t.delete(c(s,`users`,e,`tournaments`,A.id)),await t.commit();let r=y.find(t=>t.id===e);r&&(r.active=!1,r.games=0,r.wins=0,r.losses=0,r.lastPlayed=void 0),K(),[`general`,`A`,`B`].forEach(t=>{S[t].forEach(t=>{(t.p1?.id===e||t.p2?.id===e)&&(t.p1=void 0,t.p2=void 0)})}),await q(),k()}catch(e){m(`Erro ao remover atleta do torneio: `+e.message,`error`)}},window.editPlayer=async e=>{let t=y.find(t=>t.id===e);if(!t)return;let n=prompt(`Novo nome:`,t.name)?.trim();if(n){t.name=n;try{await a(c(s,`users`,e),{name:n,updatedAt:Date.now()}),y.sort((e,t)=>e.name.localeCompare(t.name)),k()}catch(e){m(`Erro ao editar atleta: `+e.message,`error`)}}},window.togglePlayer=async e=>{let t=y.find(t=>t.id===e);if(t){t.active=!t.active;try{await a(c(s,`users`,e),{"playerProfile.active":t.active}),K(),await q(),k()}catch(e){m(`Erro ao atualizar atleta: `+e.message,`error`)}}},window.showHistory=e=>{let t=y.find(t=>t.id===e);if(!t)return;let n=b.filter(t=>t.p1===e||t.p2===e).map(t=>{let n=t.p1===e,r=n?t.p2:t.p1,i=y.find(e=>e.id===r),a=t.winner===e,o=n?t.score1:t.score2,s=n?t.score2:t.score1;return`
