      ...
      <div class="athlete-profile-head">
        ...
        <div class="athlete-profile-copy">
          ...
          <div class="athlete-profile-badges">
            ...
            <span class="result-pill ${z(e)?.paymentStatus===`approved`?`win`:`loss`}">${z(e)?.paymentStatus===`approved`?`Inscrição aprovada`:`Inscrição pendente`}</span>
          </div>
        </div>
      </div>
      <div class="profile-info-grid athlete-profile-grid">
        <div class="info-card"><span>Email</span><strong>${L(r.email||`Não informado`)}</strong></div>
        <div class="info-card"><span>Telefone</span><strong>${L(r.phone||`Não informado`)}</strong></div>
