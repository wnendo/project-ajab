import"./modulepreload-polyfill-Btlm8H0F.js";import{_ as e,a as t,f as n,i as r,n as i,o as a,p as o,s,t as c,x as l}from"./firebase-VBRKn9At.js";/* empty css               */import{c as u}from"./tournament-rules-DUbpQbwy.js";function d(e){let t=(e??``).trim().toUpperCase();return t===`A`?`A`:t===`B`?`B`:t===`C`?`C`:t===`D`?`D`:t===`INICIANTE`||t===`INICIANTES`?`Iniciante`:null}function f(e){return Array.isArray(e.categories)&&e.categories.length?e.categories:e.category?e.category.split(`,`).map(e=>e.trim()).filter(Boolean):[]}function p(e,t,n,r){return t===n?r:e?.get(t)||`A definir`}function m(e,t,n,r,i){let a=n?.groups??[],o=a.find(e=>e.playerIds.includes(r.id)),s=(n?.activeTables??[]).find(e=>e.match?.playerIds.includes(r.id)),c=(n?.queue??[]).find(e=>e.playerIds.includes(r.id)),l=s?.match?(()=>{let e=p(i,s.match?.playerIds.find(e=>e!==r.id)??``,r.id,r.name);return`
